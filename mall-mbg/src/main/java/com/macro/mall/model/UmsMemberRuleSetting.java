...
public class UmsMemberRuleSetting implements Serializable {
    ...
    @ApiModelProperty(value = "Consecutive sign-in days")
    private Integer continueSignDay;

    @ApiModelProperty(value = "Number of complimentary consecutive sign-in")
    private Integer continueSignPoint;

    @ApiModelProperty(value = "Get 1 point for each Currency Unit spent")
    private BigDecimal consumePerPoint;

    @ApiModelProperty(value = "Order amount of the lowest acquisition point")
    private BigDecimal lowOrderAmount;

    @ApiModelProperty(value = "Maximum number of points per order")
    private Integer maxPointPerOrder;

    @ApiModelProperty(value = "Type: 0 - > integration rule; 1 - > growth value rule")
