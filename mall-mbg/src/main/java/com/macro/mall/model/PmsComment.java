...
public class PmsComment implements Serializable {
    ...
    @ApiModelProperty(value = "Rating stars：0->5")
    ...
    @ApiModelProperty(value = "Image addresses, separated by commas")
    private String pics;

    @ApiModelProperty(value = "Comment on a user's profile picture")
