...
public class UmsAdminController {
    ...
    @ApiOperation(value = "Get the information of the currently logged in User")
    ...
    @ApiOperation(value = "Sign out function")
    ...
    @ApiOperation("Get user list by username or name")
